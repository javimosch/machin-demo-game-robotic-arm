...
PURE="src/00_math.src src/01_armspec.src src/01b_layout.src src/01c_stations.src src/02_kinematics.src src/02b_hydraulics.src src/02c_task.src tests/test_kinematics.src"
